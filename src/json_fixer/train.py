...
train_dataset_path = "/home/rngo/code/intel-gpu-fine-tune/src/data_processing/train_data.jsonl"
eval_dataset_path = "/home/rngo/code/intel-gpu-fine-tune/src/data_processing/eval_data.jsonl"

with jsonlines.open(train_dataset_path, "r") as j:
    train_dataset = list(j)
converted_train_dataset = [convert_to_conversation(example) for example in train_dataset]

with jsonlines.open(eval_dataset_path, "r") as j:
    eval_dataset = list(j)
